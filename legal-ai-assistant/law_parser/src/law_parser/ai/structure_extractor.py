...
_ARTICLE_NO_PATTERN = "第"


def _is_article_start(line: str) -> bool:
    return _ARTICLE_NO_PATTERN in line and ("条" in line or "款" in line)
...
def _chunk_text(text: str, max_size: int = MAX_CHUNK_SIZE) -> list[str]:
    ...
    current_size = 0
    for line in lines:
        is_article = _is_article_start(line)
