...
.group-header { display:flex; align-items:center; gap:10px; .group-count { font-size:13px; color: var(--color-text-muted); } }
.empty-hint { display:flex; align-items:center; justify-content:center; height:200px; color: var(--color-text-muted); font-size:13px; }
</style>