...
.case-search-page{animation:fadeIn .4s ease;padding:0 4px}to{opacity:1;transform:translateY(0)}}.page-header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:16px}.header-content h2{margin:0 0 6px;font-size:22px;font-weight:600}.header-content p{margin:0;color: var(--color-text-muted);font-size:13px}.filter-card{margin-bottom:16px}.mono{font-family:'Cascadia Code','Consolas',monospace;font-size:12px}.pager{margin-top:14px;justify-content:flex-end;display:flex}.content-preview{background:var(--color-bg-page);padding:16px;border-radius:8px;white-space:pre-wrap;word-break:break-word;font-size:13px;line-height:1.6;border:1px solid var(--color-border);max-height:40vh;overflow-y:auto}
</style>